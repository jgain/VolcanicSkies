    ...
    namespace Model{
        class planet{
            private:
                ...
                //The speed of sound in m per second.
                double speedOfSound;// Assumed at 330 metres per second for most of Earth's atmosphere.
            ...
            public:
                ...
                const double getSpeedOfSound() const;
