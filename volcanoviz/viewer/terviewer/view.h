...
public:
    ...
    inline void incrZoom(float delta)
    {
        ...
        if(zoomdist > 3.5f * viewscale) // furthest zoom out
            zoomdist = 3.5f * viewscale;
        apply();
    }
    ...
    void projectingPointPort(int sx, int sy, vpPoint & pnt, int Port[4]);
