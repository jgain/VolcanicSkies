...
namespace data_importer
{
        ...
        struct species
        {
            ...
            treeshape shapetype; //< shape for canopy: sphere, box, cone, invcone, cylinder
	    ...
	    int maxdeadage;	//< expected maximum time for decay in months
            float maxhght;      //< expected maximum height in meters
            float maxdiam;	//< expected maximumum diameter at breast height in meters
            float max_trunk_radius;	//< expected maximum trunk radius in meters
            bool isTree;	//< whether or not the species represents a tree
	    bool isConifer;	//< whether or not the species is a conifer
	    bool isHerb; 	//< whether or not the species is a forbe/herb
            float logseeding;   //< multiplier for seedling establishment on logs
...
namespace data_importer
{
        void eliminate_outliers(MapFloat &data);
